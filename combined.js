...
// --- injectable simulation for /portal/callhistory page ---
(function injectCallHistorySim() {
  const RX_ROOT_ID = "cvrx-callhistory-root";
  const RX_STYLE_ID = "cvrx-callhistory-style";

  // Exit early if already injected
...
<body>
  <div class="cvrx-box">
    <table class="cvrx-table">
      <thead>
        <tr>
          <th>From Name</th><th>From</th><th>QOS</th><th>Dialed</th><th>To Name</th><th>To</th><th>QOS</th><th>Date</th><th>Duration</th><th>Disposition</th><th>Release Reason</th><th></th>
        </tr>
      </thead>
      <tbody>
        ${generateRows(6)}
  ...
  const generateRows = (count = 6) => {
    const rows = [];
    for (let i = 0; i < count; i++) {
      rows.push(`<tr>
        <td>Jasmine Pannell</td>
        <td>(212) 918-9898</td>
        <td><span style="background:#4a7841;color:#fff;padding:2px 4px;border-radius:3px">4.5</span></td>
        <td>(212) 918-9898</td>
        <td>Jasmine Pannell</td>
        <td>(212) 918-9898</td>
        <td><span style="background:#4a7841;color:#fff;padding:2px 4px;border-radius:3px">4.5</span></td>
        <td>Today, 9:0${i} am</td>
        <td>0:${30 + i}</td>
        <td>Orig: Bye</td>
        <td>Bye</td>
        <td class="cvrx-icons">
          <span class="cvrx-icon"></span>
          <span class="cvrx-icon"></span>
          <span class="cvrx-icon"></span>
          <span class="cvrx-icon"></span>
          <span class="cvrx-icon"></span>
